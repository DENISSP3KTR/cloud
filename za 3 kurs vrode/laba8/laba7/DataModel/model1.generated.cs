...
namespace DataModels
{
	...
	/// Server Version : 14.2
	/// </summary>
	public partial class Baza1DB : LinqToDB.Data.DataConnection
	{
		...
		public Baza1DB(string configuration)
			: base(configuration)
		{
			InitDataContext();
			InitMappingSchema();
		...
		public Baza1DB(LinqToDbConnectionOptions options)
			: base(options)
		{
			InitDataContext();
			InitMappingSchema();
		...
		public Baza1DB(LinqToDbConnectionOptions<Baza1DB> options)
			: base(options)
		{
			InitDataContext();
			InitMappingSchema();
